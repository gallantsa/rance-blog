...
class BlogDataTestCase(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_superuser(
            username="gallantsa", email="gallantsa@163.com", password="b86889"
        )
...
class IndexViewTestCase(BlogDataTestCase):
    ...
    def test_with_posts(self):
        ...
        self.assertQuerySetEqual(response.context["post_list"], [repr(p) for p in expected_qs], transform=repr)
